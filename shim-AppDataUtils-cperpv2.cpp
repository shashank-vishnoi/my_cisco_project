/**
   \file shim-AppDataUtils-cperpv2.cpp
   Implementation file for shim layer for App Data specific implementations for G8
*/
...
void ApplicationData::getSectionHeader(const uint8_t *buf, tTableHeader *p_header)
{
